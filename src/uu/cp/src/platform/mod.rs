...
#[cfg(all(
    unix,
    not(any(target_os = "macos", any(target_os = "linux", target_os = "runixos"), target_os = "android"))
))]
mod other_unix;
#[cfg(all(
    unix,
...
#[cfg(not(any(
    unix,
    any(target_os = "macos", any(target_os = "linux", target_os = "runixos"), target_os = "android")
)))]
mod other;
#[cfg(not(any(
    unix,
