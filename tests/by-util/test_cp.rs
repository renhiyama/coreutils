...
#[cfg(any(any(target_os = "linux"), target_os = "android", target_os = "freebsd"))]
...
#[test]
#[cfg(all(any(target_os = "linux"), not(feature = "feat_selinux")))]
...
#[test]
#[cfg(any(any(target_os = "linux"), target_os = "windows", target_os = "macos"))]
...
fn test_cp_debug_sparse_auto() {
    ...
    #[cfg(not(any(any(target_os = "linux"), target_os = "macos")))]
    ts.ucmd()
        .arg("--debug")
        .arg("--sparse=auto")
        .arg("a")
    ...
    #[cfg(any(any(target_os = "linux"), target_os = "macos"))]
    {
        #[cfg(target_os = "macos")]
        let expected = "copy offload: unknown, reflink: unsupported, sparse detection: unsupported";
        #[cfg(any(target_os = "linux"))]
